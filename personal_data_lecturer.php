...
<body>
    ...
    // Fetch data from your table in PHP
        $stmt = $conn->prepare("SELECT fld_absence_title, COUNT(*) as frequency FROM tbl_submission_details WHERE fld_lecturer_name = :name AND fld_absence_type = 'PERSONAL' AND fld_status = 'ACCEPTED' GROUP BY fld_absence_title");

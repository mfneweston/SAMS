...
<body>
    ...
    // Fetch data from your table in PHP
        $stmt = $conn->prepare("SELECT fld_absence_title, COUNT(*) as frequency FROM tbl_submission_details WHERE fld_lecturer_name = :name AND fld_absence_type = 'EVENT' AND fld_status = 'ACCEPTED' GROUP BY fld_absence_title");
    ...
    <form method="post" action="submission.php" enctype="multipart/form-data">
        ...
        <div class="box-container">
            <div class="box" id="first-box" style="margin-top: 50px">

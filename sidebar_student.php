...
<head>
  ...
  {
    color: teal;
    background-color: lightgray; /* Add a background color for hover and active states */
    width: 92%;
    border-radius: 0px;
  }
  ...
  .sidebar[style*="width:0"] .custom-buttons a img {
    margin-right: 0; /* Adjusted to keep the icons aligned */
    margin-left: 10px; /* Add margin to separate icons */
  }
</style>
</head>
...
<body onload="toggleSidebar()">
  ...
  } elseif (strpos($currentURL, 'absence_period.php') !== false) {
    $currentPage = 'fill';
  } elseif (strpos($currentURL, 'upload_history.php') !== false) {
    $currentPage = 'history';
  } elseif (strpos($currentURL, 'generate_report_student.php') !== false) {
    $currentPage = 'report';
  ...
  <div class="sidebar-container">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item nav-link">
          <div class="custom-buttons">
            ...
            <a id="dashboardLink" href="student_menu.php"
            class="nav-link <?php echo ($currentPage === 'dashboard') ? 'active' : ''; ?> <?php echo ($currentPage === 'dashboard') ? 'active-page' : ''; ?>"
            style="font-size: 14px; font-weight: 500; justify-content: center; margin-left: 10px">
            <img style="width: 15px; height: 15px; color: gray " src="pictures/dashboard.png" alt="Menu Icon">
            <span>Dashboard</span>
          </a>

          <a id="reviewLink" href="absence_period.php"
          class="nav-link <?php echo ($currentPage === 'fill') ? 'active' : ''; ?> <?php echo ($currentPage === 'fill') ? 'active-page' : ''; ?>"
          style="font-size: 14px;font-weight: 500; justify-content: center;margin-left: 10px">
          <img style="width: 15px; height: 15px; color: gray " src="pictures/history.png" alt="Menu Icon">
          <span>Fill Absence Information</span>
        </a>

        <a id="historyLink" href="upload_history.php"
        class="nav-link <?php echo ($currentPage === 'history') ? 'active' : ''; ?> <?php echo ($currentPage === 'history') ? 'active-page' : ''; ?>"
        style="font-size: 14px; font-weight: 500; justify-content: center;margin-left: 10px">
        <img style="width: 16px; height: 16px; color: gray; " src="pictures/watch.png" alt="Menu Icon">
        <span>Upload History</span>
      </a>

      <a id="reportLink" href="generate_report_student.php"
      class="nav-link <?php echo ($currentPage === 'report') ? 'active' : ''; ?> <?php echo ($currentPage === 'report') ? 'active-page' : ''; ?>"
      style="font-size: 14px; font-weight: 500; justify-content: center; margin-left: 10px ">
    ...
    <div>
       ...
       <a id="reportLink" href="logout.php"
      class="nav-link <?php echo ($currentPage === 'logout') ? 'active' : ''; ?> <?php echo ($currentPage === 'logout') ? 'active-page' : ''; ?>"
      style="font-size: 14px; font-weight: 500; justify-content: center; margin-left: 30px; margin-top: 200px ">

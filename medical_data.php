...
<body>
    ...
    // Fetch data from your table in PHP
        $stmt = $conn->prepare("SELECT fld_absence_title, COUNT(*) as frequency FROM tbl_submission_details WHERE fld_status='ACCEPTED' AND fld_absence_type = 'MEDICAL' GROUP BY fld_absence_title");
        $stmt->execute();
